...
insert  into `login`(`UserName`,`Password`,`Email`,`groupname`) values ('siva','siva','java@pantechmail.com','Thamas'),('tamil','tamil','java@pantechmail.com','sen');
...
insert  into `othergroup`(`UserName`,`groupname`,`Requestgroup`,`filename`,`Status`,`usercount`) values ('siva','Thamas','sen','1.jpg','Approved','1');
...
insert  into `userprofile`(`UserName`,`groupname`,`filename`) values ('tamil','sen','1.jpg');
