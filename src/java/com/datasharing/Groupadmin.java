 ...
 * @author Java
 */
@WebServlet(name = "Groupadmin", urlPatterns = {"/Groupadmin"})
   ...
   static
   {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Groupadmin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Groupadmin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    int k=Common_DB.InsertTable("mona","INSERT INTO groupadmin(UserName,Password,Email,groupname) VALUES('"+reguser+"','"+regpass+"','"+regemail+"','"+group+"')");
    int k1=Common_DB.InsertTable("mona","INSERT INTO login(UserName,Password,Email,groupname) VALUES('"+reguser+"','"+regpass+"','"+regemail+"','"+group+"')");
    if((k>0)||(k1>0))  
    {
...
//     {
   ...
   // String encry=rsa.encrypt("hello world is the first java program for the java beginners",key);
    ...
    //String decry=rsa.decrypt(encry,rsa.getPrivateKeyFromString(pri));
      ...
      final String  from="javaauditing@gmail.com";
      final String password="auditing123";
