                    ...
                    <div class="panel-body">
                        <form name="form1" id="defaultForm" method="post" action="Groupadmin">
                            ...
                            <div id="re-password-form-group" class="form-group hidden">
                                <label>Group Admin Retype password</label>
